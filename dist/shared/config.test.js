...
import { resolveSecrets, resolvePlaceholders, resolveRoutes, resolveCallerRoutes, loadProxyConfig, loadRemoteConfig, saveProxyConfig, saveRemoteConfig, CONFIG_DIR, CONFIG_PATH, PROXY_CONFIG_PATH, REMOTE_CONFIG_PATH, } from './config.js';
...
describe('resolveSecrets', () => {
    ...
    it('should use envOverrides before process.env', () => {
        ...
        const result = resolveSecrets({ GITHUB_TOKEN: '${GITHUB_TOKEN}' }, { GITHUB_TOKEN: 'from-caller-override' });
    ...
    it('should fall back to process.env when envOverrides lacks the key', () => {
        ...
        const result = resolveSecrets({ OTHER_TOKEN: '${OTHER_TOKEN}' }, { GITHUB_TOKEN: 'only-this-one' });
