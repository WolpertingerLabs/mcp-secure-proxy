...
const mockReaddirSync = (files) => files;
...
describe('listAvailableConnections', () => {
    ...
    it('should list available connections alphabetically', () => {
        vi.spyOn(fs, 'existsSync').mockReturnValue(true);
        vi.spyOn(fs, 'readdirSync').mockReturnValue(mockReaddirSync(['trello.json', 'github.json', 'stripe.json']));
    ...
    it('should filter out non-JSON files', () => {
        vi.spyOn(fs, 'existsSync').mockReturnValue(true);
        vi.spyOn(fs, 'readdirSync').mockReturnValue(mockReaddirSync(['github.json', 'README.md', '.DS_Store']));
        const available = listAvailableConnections();
