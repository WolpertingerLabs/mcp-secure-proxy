...
import { generateKeyBundle, saveKeyBundle, extractPublicKeys, fingerprint, loadKeyBundle, } from '../crypto/index.js';
import { CONFIG_DIR, CONFIG_PATH, LOCAL_KEYS_DIR, REMOTE_KEYS_DIR, PEER_KEYS_DIR, saveConfig, } from '../config.js';
// ── Helpers ────────────────────────────────────────────────────────────────
...
function copyPublicKeys(sourceDir, destDir) {
